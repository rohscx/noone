...
module.exports = function (networkId,apiKey,srcIp) {
    var options = { method: 'GET',
        url: `https://api.meraki.com/api/v0/networks/${networkId}/events?productType=appliance&includedEventTypes[]=ip_conflict&includedEventTypes[]=dhcp_problem&includedEventTypes[]=dhcp_no_leases&includedEventTypes[]=rogue_dhcp`,
        headers: { 
